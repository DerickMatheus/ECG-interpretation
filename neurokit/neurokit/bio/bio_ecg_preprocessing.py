...
def ecg_wave_detector(ecg, rpeaks):
    ...
    *Authors*
    ...
    for index, rpeak in enumerate(rpeaks[:]):
        ...
        try:
            if(index == 0):
                epoch_before = np.array(ecg)[0:int(rpeak)]
            else:
            ...
            q_waves.append([q_wave, index])
            p_waves.append([p_wave, index])
            q_waves_starts.append([q_start, index])
        except ValueError:
            pass
        except IndexError:
            pass
        ...
        try:
            if(index == len(rpeaks)):
                epoch_after = np.array(ecg)[int(rpeak):int(len(ecg))]
            else:
            ...
            s_waves.append([s_wave, index])
            t_waves.append([t_wave, index])
            t_waves_starts.append([t_start, index])
            t_waves_ends.append([t_end, index])
        except ValueError:
            pass
        except IndexError:
            pass
